  ...
  return (
    <header className="xs:block sm:flex justify-center xxs:mr-16 md:mr-0 align-center">
      <div className="grid grid-cols-1 font-monsterratBold xl:px-[13%]">
        ...
        <motion.div
          className="grid sm:mt-[-3%] xs:mt-[-8%] md:mt-[4%] sm:gap-y-0 md:gap-y-5 select-none xxs:mt-[-7%] xxs:ml-10 ml-0"
          {...animateHeader}
        >
          <motion.h3
            {...animateHeaderText}
          ...
          >
            <motion.span
              className="bg-clip-text dark:mix-blend-screen text-oceanBlue"
          ...
          >
            Car
            <strong className="text-oceanBlue dark:mix-blend-screen font-bold">
              Exhibition
            </strong>
          </motion.h4>
          <BtnRotator
      ...
      <motion.div
        {...animateSocialIcons}
        className="xxs:hidden md:grid justify-end xs:mt-[-5%] sm:mt-[9%] md:py-16"
      >
        <Telegram />
        <Instagram />
        <Facebook />
