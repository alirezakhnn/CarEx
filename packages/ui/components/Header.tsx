...
export function Header() {
    return (
        <header className="xs:block sm:flex justify-center md:ml-16 align-center">
            <div className="grid grid-cols-1 font-monsterratBold xl:px-[13%]">
                <Slider />
                <div className="grid sm:mt-[-3%] xs:mt-[-8%] md:mt-[4%] sm:gap-y-0 md:gap-y-5
                select-none xxs:mt-[-7%] xxs:ml-10 ml-0">
                    <Typography
                        variant="h3"
                        className="dark:text-white xl:text-4xl 
