...
function CarsDetailsPage(_a) {
    ...
    var deleteHandler = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch("api/delete/" + data._id, {
                        method: 'DELETE'
                    })];
                case 1:
                    res = _a.sent();
    ...
    if (data) {
        return (react_1["default"].createElement("div", { className: "grid justify-center my-4 mx-10" }, data === null || data === void 0 ? void 0 :
            ...
            react_1["default"].createElement("div", { className: "grid grid-cols-2 gap-x-6" },
                react_1["default"].createElement(Button_1.BtnShadow, { className: "bg-oceanBlue hover:shadow-md hover:shadow-oceanBlue", href: '/' }, "Back To Home"),
                react_1["default"].createElement(Button_1.BtnShadow, { color: "warning", variant: "contained", href: "/", onClick: deleteHandler }, "Delete"))));
    }
    else
