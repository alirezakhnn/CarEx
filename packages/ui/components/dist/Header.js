...
function Header() {
    ...
    return (React.createElement("header", { className: "flex font-monsterrat justify-around" },
        React.createElement(image_1["default"], { src: imageSource, alt: "CarExHead", width: 500, height: 500, className: " hidden dark:block absolute top-0 object-cover opacity-[12%] w-full\n                    h-[80%] bg-center bg-fixed justify-self-center z-[-1]\n                    " }),
        React.createElement("div", { className: "grid mt-5" },
            React.createElement(Logo_1.Logo, { className: 'xl:text-2xl' }),
            React.createElement(material_1.Typography, { variant: "h3", className: "dark:text-white text-3xl max-w-[450px]" },
                React.createElement("span", { className: "text-oceanBlue" }, "Feel"),
                " Modernity and",
                React.createElement("span", { className: "bg-gradient-to-r from-oceanBlue to-silver bg-clip-text text-transparent text-oceanBlue" }, "Futuristic")),
            ...
            React.createElement(Button_1.BtnRotator, { href: "#", className: "w-[150px] h-[80px] text-sm mt-5 justify-self-left text-[22px]\n                    " }, "Start")),
