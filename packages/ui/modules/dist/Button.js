...
exports.BtnShadow = function (_a) {
    ...
    return (react_1["default"].createElement(Button_1["default"], { className: "my-3 px-4 py-2 rounded-lg dark:text-white  bg-oceanBlue font-monsterratBold hover:shadow-md hover:shadow-oceanBlue hover:scale-110 transition-all", onClick: onClick }, children));
};
