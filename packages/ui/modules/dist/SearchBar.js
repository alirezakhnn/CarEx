...
function SearchBar() {
    return (React.createElement("form", { className: "searchBar-form" },
        React.createElement("label", { htmlFor: "searchBar-form_search", className: "searchBar-form_label" },
            React.createElement("input", { className: "input", type: "text", required: true, placeholder: "Search", id: "searchBar-form_search" }),
            React.createElement("div", { className: "fancy-bg" }),
            React.createElement("div", { className: "SearchBar-form_search" },
                React.createElement("svg", { viewBox: "0 0 24 24", fill: "#116AE3", "aria-hidden": "true", className: "r-14j79pv r-4qtqp9 r-yyyyoo r-1xvli5t r-dnmrzs r-4wgw6l r-f727ji r-bnwqim r-1plcrui r-lrvibr" },
            ...
            React.createElement("button", { className: "close-btn", type: "reset" },
