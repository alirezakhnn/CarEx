...
exports.TimeLine = function () {
    ...
    return (react_3["default"].createElement(react_3["default"].Fragment, null, status === "authenticated" && data ? (react_3["default"].createElement(react_vertical_timeline_component_1.VerticalTimeline, null,
        data.map(function (element) { return (react_3["default"].createElement(react_vertical_timeline_component_1.VerticalTimelineElement, { key: element._id, className: "vertical-timeline-element vertical-timeline-element--work text-midnight dark:text-white", date: element.date, iconStyle: iconstyle, icon: react_3["default"].createElement(Icons_1.CarIcon, { icon: element.title }) },
            element.picture ? (react_3["default"].createElement("img", { src: element.picture, alt: element.alt, className: "opacity-[85%] md:ml-8 rounded-xl", width: 400, height: 400 })) : react_3["default"].createElement(SquareLoader_1.SquareLoader, null),
